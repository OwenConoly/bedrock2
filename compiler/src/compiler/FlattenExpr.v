...
Section FlattenExpr1.
                ...
                ** unfold genFresh_if_needed in *.
                   ...
                   { apply_in_hyps genFresh_spec. simp.
                     ...
                     split. 2: {
                       ...
                       unfold disjoint. intro kk.
                       (* TODO set_solver should do this case analysis *)
                       destr (String.eqb kk resVar); auto.
                     }
                     move D at bottom.
  ...
  Proof.
    ...
    eapply FlatImp.exec.intersect; try assumption; cycle 1.
    - exact P.
  ...
  Proof.
    intros. eapply FlatImp.exec.intersect; try assumption.
